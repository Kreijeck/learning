...
class VectorND:
    ...
    def __init__(self, *args: Any, dtype: Any = 'd') -> None:
        ...
        '''
        # if a list is given here: *args = [1,2,3]
        if len(args) == 1 and isinstance(args[0], list):
            self.values = array.array(dtype, args[0])
        # elif we have multiple values *args = 1, 2, 3
        elif len(args) > 0:
    ...
    def __mul__(self, other: Union[SupportsFloat, VectorND]) -> Union[SupportsFloat, VectorND]:
        ...
        Args:
            other (Union[SupportsFloat, VectorND]): Other vector instance or scaler
        ...
        Returns:
            Union[SupportsFloat, VectorND]: The multiplication of the self vector and the other
